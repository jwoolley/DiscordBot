...
MongoDb.prototype.insertOne = function(collection, newRow) {
  if (typeof collection === 'string') {
    collection = this.db.collection(collection);
  }
 
  return collection.insertOne(newRow);
}

MongoDb.prototype.insertMany = function(collection, newRows) {
  if (typeof collection === 'string') {
    collection = this.db.collection(collection);
  }
 
  return collection.insertMany(newRows);
}
